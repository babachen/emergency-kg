...
public class KgVO {
    ...
    @Data public static class GraphVO { private List<GraphNodeVO> nodes = new ArrayList<>(); private List<GraphLinkVO> links = new ArrayList<>(); private List<Map<String, Object>> cypherRows = new ArrayList<>(); private Long total = 0L; private Long current = 1L; private Long pageSize = 10L; private String message; }
